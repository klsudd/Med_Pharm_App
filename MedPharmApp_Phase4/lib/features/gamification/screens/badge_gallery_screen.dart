// ============================================================================
// BADGE GALLERY SCREEN - SCAFFOLDED FOR PHASE 3
// ============================================================================
// Students: This screen displays all badges (earned and locked).
//
// It shows:
// - Earned badges with gold styling and earned date
// - Locked badges with grey styling and unlock requirements
// - Progress toward locked badges (if applicable)
//
// Phase 3 Learning Goals:
// - Work with enum values
// - Display different states (earned vs locked)
// - Use GridView for gallery layout
//
// Scaffolding Level: 30% (UI structure provided, some TODOs)
// ============================================================================
...
/// BadgeGalleryScreen - Shows all available and earned badges
class BadgeGalleryScreen extends StatelessWidget {
  ...
  // ==========================================================================
  // TODO 1: GET ICON FOR BADGE TYPE
  // ==========================================================================

  /// Get the appropriate icon for each badge type
  ///
  /// TODO: Implement this method to return appropriate icons
  /// Hints:
  /// - Use a switch statement on badgeType
  /// - Streak badges: Icons.local_fire_department
  /// - Milestone badges: Icons.emoji_events
  /// - Early bird: Icons.wb_sunny
  /// - Perfect week: Icons.calendar_today
  /// - Dedicated: Icons.workspace_premium
  ///
  /// Or use the iconName from BadgeTypeExtension (bonus challenge):
  /// The extension already defines icon names, but they're strings.
  /// You could create a mapping from string to IconData.
  IconData _getIconForBadge(BadgeType badgeType) {
    // TODO: IMPLEMENT THIS METHOD
    // Return appropriate icon for each badge type
    switch (badgeType) {
...
//
// 1. GridView.builder:
//    - Creates a grid of items
//    - SliverGridDelegateWithFixedCrossAxisCount: fixed columns
//    - crossAxisCount: 3 means 3 columns
//    - childAspectRatio: width/height ratio of each cell
//    - shrinkWrap: true + NeverScrollableScrollPhysics for nested scrolling
//
// 2. Working with Enums:
//    - BadgeType.values gives list of all enum values
//    - Use .where() to filter
//    - Use .contains() to check membership
//    - Extensions add methods like displayName
//
// 3. Bottom Sheet Pattern:
//    - showModalBottomSheet for details popup
//    - RoundedRectangleBorder for rounded top corners
//    - MainAxisSize.min for content-sized height
//
// 4. Conditional Styling:
//    - isEarned changes colors, borders, icons
//    - Ternary operators: isEarned ? gold : grey
//    - Different text styles for earned vs locked
//
// 5. Set Operations:
//    - earnedTypes = earnedBadges.map((b) => b.badgeType).toSet()
//    - .toSet() converts List to Set (fast lookup)
//    - earnedTypes.contains(type) is O(1)
//
// ============================================================================
