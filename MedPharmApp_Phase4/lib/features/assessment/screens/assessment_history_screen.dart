...
class _AssessmentHistoryScreenState extends State<AssessmentHistoryScreen> {
  ...
  void initState() {
    super.initState();
    // TODO 1: Load assessment history when screen opens
    // Hint: Use WidgetsBinding.instance.addPostFrameCallback()
    // to call provider method after build completes
    //
    // Pattern:
    ...
    //   if (studyId != null) {
    //     assessmentProvider.loadAssessmentHistory(studyId);
    //   }
    // });
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _loadHistory();
