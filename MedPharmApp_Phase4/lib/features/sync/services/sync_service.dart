...
/// Service for managing offline-first data synchronization
///
/// This service handles:
/// - Adding items to the sync queue
/// - Processing pending items when online
/// - Retry logic with exponential backoff
/// - Deadline tracking for regulatory compliance
class SyncService {
  ...
  ///
  /// Call this whenever data is saved locally that needs to sync to server.
  /// The item will be processed when connectivity is available.
  ...
  ///
  /// This is the main sync method. Call it when:
  /// - App comes online
  ...
  ///
  /// Keeps the last 7 days of completed items for debugging.
